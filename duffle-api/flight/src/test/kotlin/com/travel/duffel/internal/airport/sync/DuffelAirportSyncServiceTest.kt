package com.travel.duffel.internal.airport.sync
...
import com.travel.duffel.internal.airport.service.sync.AirportUpsertService
...
class DuffelAirportSyncServiceTest {
    ...
    private fun syncService(
        ...
        val upsertService =
            AirportUpsertService(airportRepository, syncStateRepository, mock(AirportDocumentRepository::class.java))
